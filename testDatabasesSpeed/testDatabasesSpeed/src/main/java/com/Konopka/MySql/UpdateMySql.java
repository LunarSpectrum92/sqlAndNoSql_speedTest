...
public class UpdateMySql implements UpdateInterface {

    public static Connection connection;

    public UpdateMySql(Connection connection){
        UpdateMySql.connection = connection;
    }
    ...
    public Long updateRecordInEmployeeTable(Row row) {
        ...
        try (PreparedStatement preparedUpdate = connection.prepareStatement(updateSql)) {
            ...
            preparedUpdate.setObject(2, employeeId.toString());
