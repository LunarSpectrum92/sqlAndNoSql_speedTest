...
public class ReadCassandraOld implements ReadInterface {

    public static CqlSession session;

    public ReadCassandraOld(CqlSession session) {
        ReadCassandraOld.session = session;
    }
    ...
    public Long SelectOrders() {
        try{
            ...
            Long endTime = System.nanoTime();
                System.out.println(Objects.requireNonNull(resultSet.one()).toString());
